...
public class ServerBeanRuntimeMatcherTest extends TestCase {
	...
	public void setUp() {
		...
		expected.put(IJBossToolingConstants.SERVER_WILDFLY_250, new Data(JBossServerType.WILDFLY250, "25.0"));
		expected.put(IJBossToolingConstants.SERVER_WILDFLY_260, new Data(JBossServerType.WILDFLY260, "26.0"));
