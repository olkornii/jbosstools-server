...
public class SingleServerRuntimeTest {
	...
	public void operateDeploy() {
		...
		String serverName = ServerRuntimeUIConstants.getServerName(serverIdentification);
        boolean usesJakartaProject = ServerRuntimeUIConstants.usesJakartaNamespaceDeployments(serverIdentification);
