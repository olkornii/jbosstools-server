...
public class ExtendedServerPropertiesAdapterFactory implements IAdapterFactory, IJBossToolingConstants {
	...
	public ServerExtendedProperties getExtendedProperties(Object adaptableObject) {
		...
		if( typeId != null ) {
			...
			if( SERVER_WILDFLY_260.equals(typeId) || WILDFLY_260.equals(typeId))
				return new Wildfly15PlusExtendedProperties(adaptable, "26.0");
			if( SERVER_WILDFLY_250.equals(typeId) || WILDFLY_250.equals(typeId))
				return new Wildfly15PlusExtendedProperties(adaptable, "25.0");
			if( SERVER_WILDFLY_240.equals(typeId) || WILDFLY_240.equals(typeId))
				return new Wildfly15PlusExtendedProperties(adaptable, "24.0");
			if( SERVER_EAP_74.equals(typeId) || EAP_74.equals(typeId))
				return new JBossEAP73ExtendedProperties(adaptable, "7.4");
			if( SERVER_WILDFLY_230.equals(typeId) || WILDFLY_230.equals(typeId))
				return new Wildfly15PlusExtendedProperties(adaptable, "23.0");
