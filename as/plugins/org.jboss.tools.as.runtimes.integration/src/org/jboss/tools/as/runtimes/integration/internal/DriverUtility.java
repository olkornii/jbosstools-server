...
public class DriverUtility implements IRuntimeIntegrationConstants {
	...
	static {
		...
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_220, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_230, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.EAP_74, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_240, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_250, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
		RUNTIME_DRIVER_LOCATION.put(IJBossToolingConstants.WILDFLY_260, new Pair(HSQLDB_DRIVER_72_EAP61_LOCATION, H2_TYPE));
